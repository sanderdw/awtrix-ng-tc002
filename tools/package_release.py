...
source=['.gitignore','CMakeLists.txt','cmake','src','tools','tests','patches','upstream','vendor','assets','docs','pyproject.toml','uv.lock','README.md','CONTRIBUTING.md','LICENSE.md','THIRD-PARTY-NOTICES.md']
def include(info):
...
with zipfile.ZipFile(dist/'awtrix-tc002-release.zip','w',compression=zipfile.ZIP_DEFLATED) as archive:
    ...
    notices=[root/name for name in ['README.md','docs/WORKLOG.md','LICENSE.md','THIRD-PARTY-NOTICES.md','upstream/awtrix-ng/THIRD-PARTY-NOTICES.md','vendor/openssl/LICENSE']]
