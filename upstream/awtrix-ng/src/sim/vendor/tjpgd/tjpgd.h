...
/* Vendored for the AWTRIX NG host simulator: always use <stdint.h>. The
   original _WIN32 fallback typedefs (unsigned long uint32_t, ...) conflict
   with MinGW's <stdint.h> that other translation units pull in. */
#include <stdint.h>
